...
### Configuring Hosts and Vhosts

Before we install Drupal, we need to configure our hosts file and virtual hosts.
...
Edit the `httpd-vhosts.conf` Apache file for your WAMP or AMPPS installation and add the following entry:
...
```
You will need to retart your webserver for the changes to take effect.
...
Navigate to your browser and enter the path to your drupal installation, which in our case will be the path we defined in the virtual host configuration file, `http://dev.changebank.com`.
